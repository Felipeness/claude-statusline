...
# Corpo inteiro dentro de main(): um curl | sh truncado (conexão caindo no
# meio do stream) só define uma função parcial e falha ao chamá-la, em vez
# de executar metade do script direto no shell do usuário.
main() {
